<div>
  ...
  <p>
    <strong>PomDB</strong> is a NoSQL object database that leverages the robust storage capabilities of <a href="https://aws.amazon.com/s3">Amazon S3</a> to store and retrieve data. PomDB is entirely client-driven and enforces an opinionated structure for consistency, compatibility, and speed. This project is early in development and may change significantly before reaching a stable release. See the issues and project board to contribute or follow along.
  </p>
</div>
